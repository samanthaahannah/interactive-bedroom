...
* Optimised materials and textures - one gradient texture and material shared between assets
* Custom shader (URP)
* Collider-based click interaction with Unity's built-in OnMouseDown event
